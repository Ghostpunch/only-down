...
namespace OnlyDown
{
    public class GameInstaller : MonoInstaller
    {
        ...
        {
            Container.Bind<EnvironmentView>().ToTransientPrefab<EnvironmentView>(_sceneSettings.Environment.Prefab).WhenInjectedInto<EnvironmentController>();

            Container.Bind<IInitializable>().ToSingle<EnvironmentController>();
